...
|------------- | ------------- | -------------|
| [**postPaymentDetails**](PaymentInquiryApi.md#postPaymentDetails) | **POST** /payment/4.3/paymentinquiry |  |


<a name="postPaymentDetails"></a>
# **postPaymentDetails**
> PayloadRequest postPaymentDetails().payloadRequest(payloadRequest).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PaymentInquiryApi#postPaymentDetails");
