...
/**
 * API tests for CancelTransactionApi
 */
@Disabled
public class CancelTransactionApiTest {

    private static CancelTransactionApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CancelTransactionApi(apiClient);
    }
    ...
    public void postTest() throws ApiException {
        ...
        PaymentNonRedirectResponse response = api.post(paymentToken)
                .locale(locale)
                .clientID(clientID)
