...
public class ResponsePaymentChannel {
  ...
  public ResponsePaymentChannel() {
  }

  public ResponsePaymentChannel id(Integer id) {
  ...
  **/
  ...
  public ResponsePaymentChannel sequenceNo(Integer sequenceNo) {
  ...
  **/
  ...
  public ResponsePaymentChannel name(String name) {
  ...
  **/
  ...
  public ResponsePaymentChannel code(String code) {
  ...
  **/
  ...
  public ResponsePaymentChannel iconUrl(String iconUrl) {
  ...
  **/
  ...
  public ResponsePaymentChannel logoUrl(String logoUrl) {
  ...
  **/
  ...
  public ResponsePaymentChannel _default(Boolean _default) {
  ...
  **/
  ...
  public ResponsePaymentChannel channelCode(String channelCode) {
  ...
  **/
  ...
  public ResponsePaymentChannel agentChannelCode(String agentChannelCode) {
  ...
  **/
  ...
  public ResponsePaymentChannel optionName(String optionName) {
  ...
  **/
  ...
  public ResponsePaymentChannel paymentCode(String paymentCode) {
  ...
  **/
  ...
  public ResponsePaymentChannel qrType(String qrType) {
  ...
  **/
  ...
  public ResponsePaymentChannel expirationTimer(String expirationTimer) {
  ...
  **/
  ...
  public ResponsePaymentChannel expirationDescription(String expirationDescription) {
  ...
  **/
  ...
  public ResponsePaymentChannel expiration(Boolean expiration) {
  ...
  **/
   ...
   * @return the ResponsePaymentChannel instance itself
   */
  public ResponsePaymentChannel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ResponsePaymentChannel responsePaymentChannel = (ResponsePaymentChannel) o;
    return Objects.equals(this.id, responsePaymentChannel.id) &&
        Objects.equals(this.sequenceNo, responsePaymentChannel.sequenceNo) &&
        Objects.equals(this.name, responsePaymentChannel.name) &&
        Objects.equals(this.code, responsePaymentChannel.code) &&
        Objects.equals(this.iconUrl, responsePaymentChannel.iconUrl) &&
        Objects.equals(this.logoUrl, responsePaymentChannel.logoUrl) &&
        Objects.equals(this._default, responsePaymentChannel._default) &&
        Objects.equals(this.channelCode, responsePaymentChannel.channelCode) &&
        Objects.equals(this.agentChannelCode, responsePaymentChannel.agentChannelCode) &&
        Objects.equals(this.optionName, responsePaymentChannel.optionName) &&
        Objects.equals(this.paymentCode, responsePaymentChannel.paymentCode) &&
        Objects.equals(this.qrType, responsePaymentChannel.qrType) &&
        Objects.equals(this.expirationTimer, responsePaymentChannel.expirationTimer) &&
        Objects.equals(this.expirationDescription, responsePaymentChannel.expirationDescription) &&
        Objects.equals(this.expiration, responsePaymentChannel.expiration)&&
        Objects.equals(this.additionalProperties, responsePaymentChannel.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, sequenceNo, name, code, iconUrl, logoUrl, _default, channelCode, agentChannelCode, optionName, paymentCode, qrType, expirationTimer, expirationDescription, expiration, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponsePaymentChannel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResponsePaymentChannel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResponsePaymentChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponsePaymentChannel is not found in the empty JSON string", ResponsePaymentChannel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponsePaymentChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponsePaymentChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponsePaymentChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponsePaymentChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponsePaymentChannel>() {
           @Override
           public void write(JsonWriter out, ResponsePaymentChannel value) throws IOException {
           ...
           @Override
           public ResponsePaymentChannel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ResponsePaymentChannel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ResponsePaymentChannel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResponsePaymentChannel
  * @throws IOException if the JSON string is invalid with respect to ResponsePaymentChannel
  */
  public static ResponsePaymentChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponsePaymentChannel.class);
  }

 /**
  * Convert an instance of ResponsePaymentChannel to an JSON string
  *
  * @return JSON string
  */
